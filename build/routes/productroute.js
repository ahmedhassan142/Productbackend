...
const hybridservice_1 = require("src/service/hybridservice");
...
router.post('/add', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const category = yield category_1.default.findOne({ slug: req.body.category });
        if (!category) {
            return res.status(404).json({
                success: false,
                message: `Category with slug '${req.body.category}' not found`,
                availableCategories: yield category_1.default.find().select('slug name -_id')
            });
        }
        ...
        const createdProduct = yield product_1.default.findById(product._id)
...
router.get('/categories/:slug/products', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
router.post('/update-ratings', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const session = yield mongoose_1.default.startSession();
    session.startTransaction();
    try {
        const { productId, rating, weight = 1.0 } = req.body;
        // Validate input
...
router.get('/suggestions', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const [products, categories] = yield Promise.all([
            product_1.default.find({ name: searchRegex })
                .limit(5)
                .select('name slug'),
            category_1.default.find({ name: searchRegex })
                .limit(3)
                .select('name slug')
        ]);
        res.json({
...
router.get('/trending', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const trendingProducts = yield product_1.default.aggregate([
            {
                $addFields: {
...
router.get('/:productId/view', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
router.patch('/:productId/cart-addition', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { productId } = req.params;
...
// product.routes.ts
router.post('/update-purchases', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { productIds, increment = 1 } = req.body;
        if (!productIds || !Array.isArray(productIds)) {
            return res.status(400).json({ message: 'Invalid product IDs' });
        }
        const result = yield product_1.default.updateMany({ _id: { $in: productIds } }, { $inc: { purchases: increment } });
        res.status(200).json({
            success: true,
...
const hybridService = new hybridservice_1.HybridRecommendationService();
// For product page recommendations (shows similar + popular)
router.get('/recommendations/:productId', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const recommendations = yield hybridService.getHybridRecommendations(req.params.productId);
...
router.get('/recommendations', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const recommendations = yield hybridService.getHybridRecommendations();
    res.json(recommendations);
}));
